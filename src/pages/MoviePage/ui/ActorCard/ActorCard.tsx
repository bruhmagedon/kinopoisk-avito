      ...
      <>
         <li className="w-full cursor-pointer">
            ...
            >
               ...
               {/* Текст при наведении */}
               <PopoverContent className="text-elipsis z-50 flex max-w-[250px] items-center justify-center overflow-hidden rounded-lg bg-panel-background-dark text-white">
                  {person.name}
               </PopoverContent>
            </Popover>
         </li>
