import { useFetchMovieByIdQuery, useFetchPostersQuery, useFetchSeasonsAndSeriesQuery } from '@/entities/movies';
      ...
      <div className="relative py-[24px]">
         <div className="flex max-lg:flex-col max-lg:items-center max-lg:gap-8">
            ...
            <div className="flex flex-1 flex-col gap-8">
               <div className="flex rounded-lg bg-panel-background-dark text-white max-sm:flex-col">
               ...
               {movieData.persons.filter((person) => person.enProfession == 'actor').length > 0 && (
                  <div className="flex flex-col gap-5 font-medium text-white max-sm:p-5">
                     <h2>Актеры</h2>
                     <ActorsPagination persons={movieData.persons.filter((person) => person.enProfession == 'actor')} />
                  </div>
               )}
