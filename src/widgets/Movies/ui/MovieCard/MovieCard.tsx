      ...
      <>
         <li className="relative h-[300px] w-full cursor-pointer" onClick={onNavigate}>
            ...
            >
               ...
               <PopoverContent className="text-elipsis z-30 flex max-w-[250px] items-center justify-center overflow-hidden rounded-lg border-[1px] border-gray-700 bg-panel-background-dark p-2 text-sm text-white">
                  {movie.name
